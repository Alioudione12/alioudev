...
const Contact = () => {
  return (
    ...
    <h1 className="text-4xl font-bold text-center text-[#485460]">Contact</h1>
        <form action="https://getform.io/f/99e06e87-e663-4630-a389-f01a6f2ea25f" method="POST" encType="multipart/form-data">
            ...
            <button className="bg-[#001b5e] text-white mt-4 w-full p-4 rounded-lg">Envoyer message</button>
        </form>

        <div className="flex justify-between pt-6 max-w-[200px] m-auto text-[#485460]">
